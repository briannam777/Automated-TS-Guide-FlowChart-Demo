...
const elements = [
 ...
 \n4. If no leaks are found refer to FCTG107787 to troubleshoot bad sensor issues.',
  ...
  { id: 'e1-2', source: '1', target: '2',arrowHeadType:"arrow",style:{stroke:'red',strokeWidth:'5'} ,animated : true},
  { id: 'e2-3', source: '2', target: '3',arrowHeadType:"arrow",sourceHandle:"b",label: 'Yes'},
  {id: 'e2-7', source: '2', target: '7',arrowHeadType:"arrow",sourceHandle:"a",label: 'No',style:{stroke:'red',strokeWidth:'5'} ,animated : true},
  {id: 'e7-4', source: '7', target: '4',arrowHeadType:"arrow",sourceHandle:"a",label: 'No',style:{stroke:'red',strokeWidth:'5'} ,animated : true},
  {id: 'e4-5',source:'4',target:'5',arrowHeadType:"arrow",label: 'Yes'},
  {id: 'e4-6',source:'4',target:'6',arrowHeadType:"arrow",sourceHandle:'b',targetHandle:'a',type:"step",label: 'No, Create WO',style:{stroke:'red',strokeWidth:'5'} ,animated : true},
